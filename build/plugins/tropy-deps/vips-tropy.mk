# Derived from plugins/web-deps/vips-web.mk -- when updating to a new
# libvips release, diff that file against this one and forward-port any
# changes to the versions.json block.
...
$(PKG)_FILE      = $(vips_FILE)
$(PKG)_URL       = $(vips_URL)
$(PKG)_DEPS     := $(vips_DEPS) libjxl libraw openjpeg poppler
